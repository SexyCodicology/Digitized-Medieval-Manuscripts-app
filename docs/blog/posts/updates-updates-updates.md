...
authors:
- giulio
slug: updates-updates-updates
---
# Updates, updates, updates!

We have been working a bit in the shadows lately, and we thought it might be useful to share what we have been up to! Let's start from the DMMapp.
...
- We will be at a conference in Ghent later on this year (September). The theme will be "Discoverability of digitized medieval manuscripts". We'll have a blog post explaining what we will be speaking about exactly, so stay tuned!

That's it for now, in the next days we'll post this on the SC blog too!
