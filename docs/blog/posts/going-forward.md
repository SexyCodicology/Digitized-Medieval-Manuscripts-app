...
All our efforts will be focused on the [DMMapp](https://digitizedmedievalmanuscripts.org/): the DMMapp offers a free service used by tens of thousands of users (scholars, students, manuscripts fanatics) every year. It is by far the most visited item of our website and we are more than happy to continue improving the service and its content.
...
We remain committed to publishing the [DMMapp software as open source](https://github.com/SexyCodicology/DMMapp-Open-Source).
...
The only channel that we want to keep open is our [Patreon](https://www.patreon.com/SexyCodicology), as it is essential to cover the costs of the Sexy Codicology blog and the DMMapp.
