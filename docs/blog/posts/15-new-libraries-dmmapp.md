...
June has been a productive month for the DMMmaps project: we were at the [DH Benelux Conference in The Hague](https://dhbenelux.org/), Netherlands, presenting this project, but **we have also received many new links to that were added to the database.** So, without further ado, let's present the additions:
...
- [Oberösterreichische Landesbibliothek](https://digi.landesbibliothek.at/viewer/browse/)
- [Royal Canonry of Premonstratensians](https://digi.landesbibliothek.at/viewer/browse/)
- LMU University Library
- Biblioteca civica Cristoforo Sabbadino
- [Biblioteca del Museo Correr](https://www.nuovabibliotecamanoscritta.it/Generale/BibliotecaDigitale/manoscritti.html)
- [Biblioteca capitolare](https://www.nuovabibliotecamanoscritta.it/Generale/BibliotecaDigitale/manoscritti.html)
- [Library of Congress, Lessing J. Rosenwald Collection](https://www.loc.gov/rr/rarebook/rosenwald-MandR.html)
- Augustiner-Chorherrenstift, Bibliothek
- Castello del Buonconsiglio
- Stiftsbibliothek Kremsmünster
- [Biblioteka Uniwersytecka w Toruniu](https://www.bu.umk.pl/rekopisy-online)
